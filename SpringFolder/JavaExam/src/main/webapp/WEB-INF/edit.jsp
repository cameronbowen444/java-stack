...
<body>
	...
	<div class="container">
		<h1>Edit Show</h1>
		<form:form action="/shows/${show.id}/edit" method="put" modelAttribute="show">
			...
			<div class="mb-3">
				...
				<form:input class="form-control" type="text" path="title" value="${ show.title }" />
			</div>
			<div class="mb-3">
				<form:errors path="network" class="errors" />
				<form:label class="form-label" path="network">Show Network</form:label>
				<form:input class="form-control" type="text" path="network" value="${ show.network }" />
			</div>
			<div class="mb-3">
				<form:errors path="description" class="errors" />
				<form:label class="form-label" path="description">Show Description</form:label>
		...
		<a href="/shows/delete/${ show.id }" class="btn btn-danger">Delete</a>
